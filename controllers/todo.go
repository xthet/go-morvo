...
func (c TodoController) EditTodo(w http.ResponseWriter, r *http.Request) {
	...
	res, err := c.todo_service.EditTodo(payload, object_id)
	if err != nil {
		utils.WriteError(w, http.StatusBadRequest, err)
		return
	}
...
func (c TodoController) CompleteTodo(w http.ResponseWriter, r *http.Request) {
	id := r.URL.Query().Get("id")
	...
	err = c.todo_service.CompleteTodo(object_id)
	if err != nil {
		utils.WriteError(w, http.StatusBadRequest, err)
		return
	}
...
func (c TodoController) ApproveTodo(w http.ResponseWriter, r *http.Request) {
	id := r.URL.Query().Get("id")
	...
	err = c.todo_service.ApproveTodo(object_id)
	if err != nil {
		utils.WriteError(w, http.StatusBadRequest, err)
		return
	}
...
func (c TodoController) DeleteTodo(w http.ResponseWriter, r *http.Request) {
	...
	err = c.todo_service.DeleteTodo(object_id)
	if err != nil {
		utils.WriteError(w, http.StatusBadRequest, err)
		return
	}
